...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-2.5 text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition focus:outline-none focus:ring-2 focus:ring-purple-500"
    >
      {theme === 'dark' ? (
