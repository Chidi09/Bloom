...
export function OTAReleasePlayground() {
  ...
  return (
    <div className="p-8 sm:p-10 rounded-3xl bg-white dark:bg-black backdrop-blur border border-slate-200 dark:border-zinc-800 shadow-2xl max-w-5xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200 dark:border-zinc-800">
        <div>
          ...
          <p className="text-xs text-slate-600 dark:text-slate-400">
            Select a deployment mode to inspect <code className="font-mono text-purple-600 dark:text-purple-400 font-bold">bloom.yaml</code> configs and CLI outputs.
          </p>
        </div>
      ...
      <div className="p-5 rounded-2xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 space-y-3 font-mono text-xs">
        <div className="flex items-center justify-between text-slate-600 dark:text-slate-400 font-bold">
          ...
          <span className="text-blue-600 dark:text-blue-400 font-bold">{activeMode.trafficPct}% Canary Traffic</span>
        </div>
        <div className="w-full h-2.5 bg-slate-200 dark:bg-zinc-900 rounded-full overflow-hidden border border-slate-300 dark:border-zinc-800">
          <div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-3">
          <div className="flex items-center justify-between text-xs font-mono text-slate-500 dark:text-slate-400">
            <span className="font-bold text-slate-900 dark:text-white">bloom.yaml</span>
            <span className="px-2 py-0.5 rounded bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20 text-[10px] font-bold">
              {activeMode.badge}
            </span>
          </div>
        ...
        <div className="lg:col-span-7 space-y-3">
          <div className="flex items-center justify-between text-xs font-mono text-slate-500 dark:text-slate-400">
            <span className="font-bold text-slate-900 dark:text-white">{activeMode.command}</span>
            <span className="text-emerald-600 dark:text-emerald-400 font-bold text-[10px]">RSA-2048_SIGNED</span>
          </div>

          <div className="rounded-2xl overflow-hidden bg-slate-950 dark:bg-black border border-slate-800 dark:border-zinc-800 font-mono text-xs shadow-xl">
            <div className="flex items-center gap-2 px-4 py-3 bg-slate-900 dark:bg-zinc-950 border-b border-slate-800 dark:border-zinc-800 text-[11px] text-slate-400 font-bold">
