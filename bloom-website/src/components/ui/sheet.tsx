...
export function Sheet({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      />
      <div
        className="relative z-10 w-full max-w-lg bg-white dark:bg-[#0D1117] border border-slate-200 dark:border-slate-800 p-6 shadow-2xl transition-transform transform translate-y-0 sm:rounded-2xl"
        style={{
