...
> Source: https://ui.shadcn.com/docs/components/aria/hover-card
...
```
Copyimport { HoverCard, HoverCardTrigger } from "@/components/ui/hover-card"```

```
Copy<HoverCardTrigger>
...
```
Copy<HoverCardTrigger delay={100} closeDelay={200}>
  <Button variant="link">Hover</Button>
