...
> Source: https://ui.shadcn.com/docs/components/aria/sidebar
...
```
Copy<Collapsible defaultExpanded className="group/collapsible">
  <SidebarGroup>
...
```
Copy<SidebarMenuButton href="#" isActive>
  Home
</SidebarMenuButton>```
