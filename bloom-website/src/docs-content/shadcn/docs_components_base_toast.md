...
> Source: https://ui.shadcn.com/docs/components/base/toast
...
```
Copyimport { Toaster } from "@/components/ui/toast"
...
```
Copyimport { toast } from "@/components/ui/toast"```
