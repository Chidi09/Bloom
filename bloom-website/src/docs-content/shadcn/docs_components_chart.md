...
> Source: https://ui.shadcn.com/docs/components/chart#tooltip
...
**Updated:** The `chart` component now uses Recharts v3. If you're upgrading existing chart code, see Updating to Recharts v3.
