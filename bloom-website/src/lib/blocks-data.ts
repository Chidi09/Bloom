export interface ApplicationBlock {
  id: string;
  title: string;
  category: 'Dashboard' | 'Authentication' | 'Chat & AI' | 'Settings' | 'Marketing';
  description: string;
  flutterCode: string;
}

export const BLOCKS_DATA: ApplicationBlock[] = [
  {
    id: 'dashboard-01',
    title: 'Analytics & Revenue Dashboard',
    category: 'Dashboard',
    description: 'Production dashboard layout with revenue metrics, interactive area chart, recent transactions, and date filter.',
...
class DashboardScreen extends StatelessWidget {
  ...
  },
  {
    ...
    description: 'Sign-in form card with email input, password visibility toggle, remember me checkbox, and social auth buttons.',
    flutterCode: `import 'package:flutter/material.dart';
import 'package:bloom_ui/bloom_ui.dart';
...
class AuthCardScreen extends StatelessWidget {
  ...
  },
  {
    ...
    category: 'Chat & AI',
    description: 'Complete AI messaging UI with message bubble reactions, file attachment pills, and bottom prompt bar.',
    flutterCode: `import 'package:flutter/material.dart';
import 'package:bloom_ui/bloom_ui.dart';
...
class AiChatScreen extends StatelessWidget {
  ...
  },
  {
    ...
    category: 'Settings',
    description: 'Account profile, appearance theme toggle, push notification switches, and danger zone actions.',
    flutterCode: `import 'package:flutter/material.dart';
import 'package:bloom_ui/bloom_ui.dart';
