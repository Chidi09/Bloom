...
BloomSonner.error(context, 'Build compilation failed. Check logs.');`,
  ...
  // 4. DATA DISPLAY & AI
  {
    ...
    props: [
      { name: 'image', type: 'ImageProvider?', description: 'User image source.' },
      { name: 'name', type: 'String?', description: 'Fallback name for initials.' },
      { name: 'size', type: 'BloomAvatarSize', defaultVal: 'defaultSize', description: 'Size step: sm, defaultSize, lg.' },
      { name: 'badge', type: 'Widget?', description: 'Optional status indicator badge.' },
    ],
    usageCode: `BloomAvatar(
  name: 'Solana Dev',
  size: BloomAvatarSize.defaultSize,
)`,
    previewType: 'avatar',
  },
  {
