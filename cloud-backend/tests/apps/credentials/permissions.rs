...
#[test]
fn test_credential_organization_extensions() {
    let org_id = CurrentOrganizationId(303);
    assert_eq!(org_id.0, 303);
...
#[test]
fn test_credential_role_matrix_rules() {
    ...
    // Read access requires Viewer (metadata only)
    ...
    // Create / Delete / Test requires Admin
