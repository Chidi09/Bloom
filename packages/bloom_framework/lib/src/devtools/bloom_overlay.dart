...
class BloomDevOverlay extends StatelessWidget {
  const BloomDevOverlay({super.key});

  /// Show the Bloom developer bottom sheet modal.
  static Future<void> show(BuildContext context) {
    return showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (_) => const BloomDevOverlay(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final envEntries = BloomEnv.all.entries.toList();
                    ...
                    child: TabBarView(
                      children: [
                        ...
                        ListView(
                          ...
                          children: [
                            _buildInfoTile('Project Name', config.name),
                            _buildInfoTile('Version', config.version),
                            _buildInfoTile('Active Flavor', Bloom.activeFlavor ?? 'None (Default)'),
                            _buildInfoTile('Mode', config.mode),
