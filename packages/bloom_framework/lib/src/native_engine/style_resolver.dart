...
enum BloomFlexWrap {
  /// Single-line flex container without wrapping.
  nowrap,

  /// Multi-line flex container wrapping items in normal direction.
  wrap,

  /// Multi-line flex container wrapping items in reverse direction.
  wrapReverse,
}

/// Resolved computed CSS layout, sizing, typography, and visual styling rules.
///
/// Generated by [BloomStyleResolver] from utility class tokens (e.g. Tailwind CSS)
/// and inline CSS style strings.
///
/// Example:
/// ```dart
...
///
/// Parses Tailwind-like utility tokens (e.g. `'flex flex-row items-center gap-4 bg-zinc-900 text-white rounded-lg'`)
/// and inline CSS strings into a strongly typed [BloomComputedStyle] in sub-millisecond time.
///
/// Example:
/// ```dart
